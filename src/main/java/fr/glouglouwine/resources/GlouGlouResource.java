...
public class GlouGlouResource {
	...
	public Response addBottle(Bottle bottle) {
		...
		//Use jmx disable the functionality
		logger.debug("Adding bottle #" + bottle.getBottleId());
		Bottle lBottle = new Bottle(bottle.getBottleId(), bottle.getOwner(), bottle.getGrapeType(), bottle.getDomain(),
				bottle.getYear());
